...
telnet_on_connection:   ; called when a connection happens
...
ansi: .byte "ascii/ANSI",0
mode: .byte " mode",10,0
remote_host: .byte 5,"hostname (leave blank to quit)",10,": ",0
remote_port: .byte "port # (leave blank for default)",10,": ",0
char_mode_prompt: .byte "mode - V=vt100, A=ascii(ANSI), P=petscii",10,0

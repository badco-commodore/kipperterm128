...
erase_line_by_number:
  ...
  pha
  ldy #0
  jsr cursor_plot		; move cursor to line
...
; copy font        
  lda #$20      ; copy 4 pages = 1KB
  ldy #$00
  ldx #$12
  jsr $CCDC
  inx
  lda $#00
  jsr $cdcc     		; point VDC to $200
:
...
@8byteVDC			; fill extra 8 bytes with 0
  ...
  bne :-
  lda #<refer_font_table
  cmp temp_ptr_z+1
  bne :-

	;; repeat for reverse characters
